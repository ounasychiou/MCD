...
--********************************************************************************
-- UPDATE
UPDATE employes SET salaire =5000, service='direction' WHERE prenom='cesaire'; -- modifie le salaire de l'employe dont le prenom est 'cesaire' avec une valeur de 5000.
...
SELECT COUNT(DISTINCT service) AS services_de_notre_entreprise FROM employes;
